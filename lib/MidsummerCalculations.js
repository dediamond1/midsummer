...
class MidsummerCalculations
{
    ...
    getTotalGrossCost = () => {
        return Math.round(this.getWaveRetrofitCost() + this.getElectricianCost() + this.getScaffoldingCost())
    }
    ...
    getGrandTotal = () => {
        return Math.round(this.getTotalNetCost() * MidsummerOptions.greenEnergyDeduction + this.getShipping())
    }
}
